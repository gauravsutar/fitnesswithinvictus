        ...
        <div className="footer-content">
          ...
          <div className="footer-brand">
            <Link to="/" className="footer-logo">
              <span className="footer-brand-text">Fitness with Invictus</span>
            </Link>
            <p className="footer-description">
              Transform your body with professional fitness training, video courses, 
              and personalized coaching for your fitness journey.
            </p>
          </div>
          ...
          <div className="footer-links">
            ...
            <ul className="footer-nav">
              ...
              <li>
                <Link to="/video-courses" className="footer-link">Video Courses</Link>
              </li>
              <li>
